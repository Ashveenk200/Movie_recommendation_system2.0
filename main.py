...
#add images and  movies from this api 
...
app = FastAPI(title="Movie Recommendation System 2.0" , version="1.0")
...
print("tfidf matrix path ========",TFIDF_MATRIX_PATH)


df: Optional[pd.DataFrame] = None
indices_obj: Any = None
tgidf_matrix: Any = None
tfidf_obj: Any = None

TITLE_TOIDX: Optional[Dict[str, int]] = None
